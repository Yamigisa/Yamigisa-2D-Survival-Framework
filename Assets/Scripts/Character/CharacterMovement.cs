...
namespace Yamigisa
{
    ...
    public class CharacterMovement : MonoBehaviour
    {
        ...
        private Vector2 lastDirection = Vector2.down; // default facing down/front
        ...
        private void HandleMovement()
        {
            ...
            // 🚫 Prevent diagonal movement (priority system)
            if (inputDirection.x != 0 && inputDirection.y != 0)
            {
                // Option A: prioritize horizontal movement
                inputDirection.y = 0;

                // Option B (if you prefer vertical first):
                // inputDirection.x = 0;
            }
